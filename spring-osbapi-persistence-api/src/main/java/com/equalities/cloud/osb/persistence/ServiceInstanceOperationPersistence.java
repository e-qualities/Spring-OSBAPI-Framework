 ...
 */
public interface ServiceInstanceOperationPersistence {
   ...
   */
  Mono<ServiceInstanceOperationEntity> insert(ServiceInstanceOperationEntity operation);
   ...
   */
  Mono<ServiceInstanceOperationEntity> update(ServiceInstanceOperationEntity operation);
   ...
   */
  Mono<Void> delete(ServiceInstanceOperationEntity operation);
   ...
   */
  Mono<ServiceInstanceOperationEntity> readByOperationId(String operationId);
}